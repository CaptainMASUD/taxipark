...
import { Eye, EyeOff, Lock, Mail, User, AlertCircle, Loader, LogOut, Search } from 'lucide-react'
...
const DriversTable = ({ user, onLogout }) => {
      ...
      <div className="bg-gray-800 shadow-lg border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold text-white">TaxiPark Dashboard</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            ...
            {selectedDrivers.size > 0 && (
              <div className="flex gap-2">
                ...
                >
                  Connect Selected ({selectedDrivers.size})
                </button>
                <button
...
export default function LoginPage() {
  ...
  if (user) {
    return <DriversTable user={user} onLogout={handleLogout} />
  }
      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-700">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to your TaxiPark account</p>
          </div>
